...
//		redirect(action: "show", id: bookInstance.id)
	...
	def update() {
//		params.put("id",maps.get(0))
//		params.put("Title", maps.get(1))
//		params.put("Price", maps.get(2))
//		params.put("Publish", maps.get(3))
		def bookInstance = Book.get(params.id)
		if (!bookInstance) {
			flash.message = message(code: 'default.not.found.message', args: [message(code: 'book.label', default: 'Book'), params.id])
			redirect(action: "list")
...
//        }
	...
	def bookjson = {
		...
		rows = array{
				for(b in results) {
					book(id:b.id,Title:b.title,Price:b.price,Publish:b.publish)
